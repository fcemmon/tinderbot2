  ...
  register_instance_option :controller do
    proc do
      if current_user.admin?
        ...
        # stacked jobs
        @jobs_stacked = ((Time.now.utc.to_date-15.days)..(Time.now.utc.to_date)).to_a
...
RailsAdmin.config do |config|
  ...
  config.model 'AccountStatusUpdate' do
    ...
    list do
      ...
      field :updated_at do
        pretty_value do
          value ? "#{ActionView::Helpers::DateHelper.time_ago_in_words(value)}" : nil
        end
      end
    end
  end
  ...
  config.model 'Schedule' do
    ...
    list do
      ...
      # field :created_at do
      #   pretty_value do
      #     "#{ActionView::Helpers::DateHelper.time_ago_in_words(value)} ago"
      #   end
      # end
  ...
  config.model 'SwipeJob' do
    ...
    list do
      ...
      field :scheduled_at do
        ...
        #   # if value < Time.now
        #   #   # "#{ActionView::Helpers::DateHelper.distance_of_time_in_words(Time.now, value)} ago"
        #   #   "-"
        #   # else
        #   #   "in #{ActionView::Helpers::DateHelper.distance_of_time_in_words(Time.now, value)}"
        #   # end
        # end
      end
      field :retries do
