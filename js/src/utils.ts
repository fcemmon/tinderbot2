...
export const sendUserTelegramMessage = async (userID: number, message: string) => {
  ...
  await axios.post('https://api.telegram.org/bot5342174081:AAG--n9K81UqHCkXTRohuADekJ0DgMrZRtc/sendMessage', data, {
...
export const delay = (time: number) => {
  if (time >= 5000) { tlog("delaying", time / 1000.0, "seconds") }
